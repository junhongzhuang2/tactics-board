...
export const FORMATIONS = {
  ...
  vstack: {
    label: '竖排',
    red:  [[0.174,0.457],[0.172,0.768],[0.42,0.50],[0.49,0.50],[0.56,0.50],[0.63,0.50],[0.70,0.50]],
    blue: [[0.187,0.424],[0.191,0.74],[0.411,0.556],[0.48,0.56],[0.548,0.562],[0.618,0.557],[0.688,0.562]],
    disc: [0.189,0.481],
  },
  hstack: {
    label: '横排',
    red:  [[0.219,0.439],[0.221,0.198],[0.225,0.762],[0.509,0.241],[0.509,0.447],[0.506,0.637],[0.506,0.836]],
    blue: [[0.238,0.401],[0.239,0.23],[0.24,0.729],[0.53,0.20],[0.53,0.40],[0.53,0.60],[0.53,0.80]],
    disc: [0.226,0.466],
  },
  zone: {
    label: 'Zone',
    red:  [[0.242,0.497],[0.234,0.188],[0.245,0.811],[0.513,0.205],[0.512,0.399],[0.511,0.604],[0.514,0.792]],
    blue: [[0.242,0.444],[0.288,0.375],[0.298,0.502],[0.485,0.317],[0.471,0.502],[0.491,0.698],[0.638,0.494]],
    disc: [0.252,0.531],
  },
  junk: {
    label: 'Junk',
    red:  [[0.241,0.498],[0.236,0.18],[0.245,0.808],[0.48,0.22],[0.48,0.398],[0.485,0.576],[0.487,0.781]],
